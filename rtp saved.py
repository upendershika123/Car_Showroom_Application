...
def CARS():
    ...
    table1 = ttk.Treeview(root, columns=("Column 0", "Column 1", "Column 2","column 3","column 4","Column 5", "Column 6", "Column 7","column 8","column 9")) 
    table1.heading("#0", text="CARS_INFO")
    table1.heading("#1", text="MODEL")
    table1.heading("#2", text="CAR_NAME")
    table1.heading("#3", text="MILEAGE")
    table1.heading("#4", text="SEATER")
    table1.heading("#5", text="FUELTYPE")
    table1.heading("#6", text="MINPRICE")
    table1.heading("#7", text="MAXPRICE")
    table1.heading("#8", text="AVAILABLE_CARS")
    table1.heading("#9", text="COLOR")
    table1.heading("#10", text="IMAGE")
